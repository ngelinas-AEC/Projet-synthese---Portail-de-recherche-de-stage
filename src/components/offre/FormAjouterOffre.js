...
export class FormAjouterOffre extends React.Component {
  constructor(props) {
    super(props);
  ...
  async addOffre(titre, type, secteur, ville, datededebut, datedefin, dureedustage, description, heuressemaine, competences, emploiapresstage, informationssupp
    ...
    try {
      ...
      if (response.ok) {
        ...
        this.props.history.push("/Offre");
        toast.success("Ajout d'un Offre " + titre);
        return jsonResponse;
      }
  ...
  handleAdd(event) {
    ...
    this.addOffre(titre, type, secteur, ville, datededebut, datedefin, dureedustage, description, heuressemaine, competences, emploiapresstage, informationssupp
      , formations, autresformations, competences2, descriptionposte, typedestage, dureestage, remuneration, dateparution, autresinformations, auteur, actif, supprime
      , valide);
