...
function FormEditDemande(props){
  ...
  const [DemandeID ] = useState(props.location.search.substring(4,props.location.search.length));
  ...
  async function getDemande() {
    try {
      const response = await fetch( APIDEMANDE + DemandeID);
  ...
  async function editDemande(titre, type, secteur, ville, datededebut, datedefin, dureedustage, description, heuressemaine, competences, emploiapresstage, informationssupp
    ...
    try{ 
      ...
      if(response.ok){ 
        ...
        toast.info("Fiche du Demande "+ titre+" modifié!!");
  ...
  function handleEdit(event){
    ...
    editDemande (titre, type, secteur, ville, datededebut, datedefin, dureedustage, description, heuressemaine, competences, emploiapresstage, informationssupp
      , formations, autresformations, competences2, descriptionposte, typedestage, dureestage, remuneration, dateparution, autresinformations, auteur, actif, supprime
      , valide);
  }
  ...
  function formIsValid(titre, type, secteur, ville, datededebut, datedefin, dureedustage, description, heuressemaine, competences, emploiapresstage, informationssupp
    ...
    return Object.keys(_errors).length === 0;
      ...
      <Container className='p-4 text-center'>   
        <h2>Modifier les informations du Demande</h2> 
      </Container>
          ...
          <Col>
            ...
            <Row>
              <Col xl="4" lg="4" md="4" sm="12" xs="12">
                <Button variant="primary" type="submit" onClick={handleEdit} to={"/Demande"}>
                    Enregistrer
                </Button>
            </Col>
              <Col xl="4" lg="4" md="4" sm="12" xs="12">
